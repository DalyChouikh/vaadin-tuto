...
public class MainLayout extends AppLayout {
    ...
    private void createHeader() {
        ...
        header.expand(logo);
        header.setWidthFull();
        header.addClassNames("px-0", "px-m");
    ...
    private void createDrawer() {
        RouterLink contactsView = new RouterLink("Contacts", ContactsList.class);
        contactsView.setHighlightCondition(HighlightConditions.sameLocation());
